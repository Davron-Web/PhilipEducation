...
@section('content')
    <x-admin.page-header title="Изменить тариф" :backRoute="route('admin.billing.plans.index')" />

    <form action="{{ route('admin.billing.plans.update', $plan) }}" method="POST" class="card">
        @csrf @method('PUT')
        <div class="form-grid">
