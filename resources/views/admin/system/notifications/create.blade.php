...
@section('content')
    <x-admin.page-header title="Отправить уведомление" :backRoute="route('admin.system.notifications.index')" />

    <form action="{{ route('admin.system.notifications.store') }}" method="POST" class="card">
        @csrf
        <div class="form-grid">
            ...
            <div class="form-group full">
                ...
                <textarea name="message" class="form-textarea @error('message') is-invalid @enderror" rows="5" required>{{ old('message') }}</textarea>
            ...
            <div class="form-group full">
                <div class="form-check">
                    ...
                    <span>Отметить как прочитанное сразу</span>
                </div>
            </div>
        </div>
