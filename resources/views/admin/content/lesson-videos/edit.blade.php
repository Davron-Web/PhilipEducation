...
@section('content')
    <x-admin.page-header title="Изменить видео" :backRoute="route('admin.content.lessonvideos.index')" />

    <form action="{{ route('admin.content.lessonvideos.update', $video) }}" method="POST" class="card">
        @csrf @method('PUT')
        <div class="form-grid">
