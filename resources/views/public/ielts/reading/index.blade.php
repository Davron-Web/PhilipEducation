            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                @foreach ($passages as $passage)
                    ...
                    <a
                        ...
                        class="group flex h-full flex-col rounded-2xl border border-white/10 bg-armor2/70 p-5 shadow-lg backdrop-blur-xl transition duration-300 ease-out hover:-translate-y-1.5 hover:border-skylight/40 hover:shadow-2xl hover:shadow-skylight/15"
                        data-reveal
                    >
