            ...
            <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between" data-reveal>
                <div class="relative w-full sm:max-w-xs">
                    ...
                    <input
                        ...
                        class="w-full rounded-xl border-2 border-line bg-armor2/70 py-2.5 pl-10 pr-4 text-sm text-ink placeholder:text-ink/40 backdrop-blur transition focus:border-brand focus:outline-none focus:ring-4 focus:ring-brand/15"
                    >
                </div>
                    ...
                    >
                        ...
                        @else
                            <a
                                ...
                                class="group relative block overflow-hidden rounded-2xl border border-line bg-armor2/70 p-5 shadow-lg shadow-ink/5 backdrop-blur-xl transition duration-300 ease-out hover:-translate-y-1.5 hover:border-brand/30 hover:shadow-2xl hover:shadow-brand/15"
                                data-reveal
                            >
