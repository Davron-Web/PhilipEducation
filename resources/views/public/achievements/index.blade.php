        ...
        @else
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                @foreach ($achievements as $achievement)
                    ...
                    <div
                        class="flex flex-col items-center rounded-2xl border border-white/60 bg-white/60 p-6 text-center shadow-lg shadow-ink/5 backdrop-blur-xl transition duration-300 ease-out {{ $isEarned ? 'hover:-translate-y-1.5 hover:border-brand/30 hover:shadow-2xl hover:shadow-brand/15' : 'opacity-70' }}"
                        data-reveal
                    >
                        <span
