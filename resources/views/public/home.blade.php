...
@section('content')
        ...
        <div class="mx-auto grid max-w-7xl items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:px-8 lg:py-28">
            <div data-reveal>
                ...
                <h1 class="mt-6 font-display text-[38px] font-semibold leading-[1.15] text-white sm:text-[48px] lg:text-[54px]">
                    ...
                    <span class="text-gold">вдохновляет</span> говорить
                </h1>
                ...
                <div class="mt-12 flex flex-wrap items-center gap-x-8 gap-y-3 border-t border-white/10 pt-6 text-[13px] text-white/50">
                    <div><span class="font-display text-xl font-semibold text-gold" data-counter data-target="{{ $totalUsers }}">0</span> учеников</div>
                    <div><span class="font-display text-xl font-semibold text-gold" data-counter data-target="{{ $totalWords }}">0</span> слов в словаре</div>
                    <div><span class="font-display text-xl font-semibold text-gold" data-counter data-target="{{ $totalLessons }}">0</span> уроков</div>
                </div>
            </div>
    ...
    <section id="sections" class="bg-armor py-20 sm:py-28">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center" data-reveal>
                <p class="text-xs font-bold uppercase tracking-[0.2em] text-brand">Почему Philip Education</p>
                <h2 class="mt-3 font-display text-[32px] font-semibold text-ink sm:text-[38px]">Всё для учёбы — в одном месте</h2>
                <div class="mx-auto mt-4 h-[3px] w-14 bg-gradient-to-r from-[#C9A961] to-[#D4AF37]"></div>
                <p class="mt-4 text-[16px] text-ink/60">От первого урока до свободного владения языком: каждый раздел закрывает свою часть пути.</p>
            </div>
    ...
    <section id="lessons" class="bg-armor2 py-20 sm:py-28">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center" data-reveal>
                <p class="text-xs font-bold uppercase tracking-[0.2em] text-brand">Программы</p>
                <h2 class="mt-3 font-display text-[32px] font-semibold text-ink sm:text-[38px]">Выбери свой уровень</h2>
                <div class="mx-auto mt-4 h-[3px] w-14 bg-gradient-to-r from-[#C9A961] to-[#D4AF37]"></div>
                <p class="mt-4 text-[16px] text-ink/60">От первого «Hello» до свободной академической речи — шесть уровней по шкале CEFR, бесплатно.</p>
            </div>
                ...
                @foreach ($levels as $level)
                    <div data-reveal class="card-lift overflow-hidden rounded-2xl border border-line shadow-soft">
                        <div class="relative bg-navy px-6 py-8">
                            @if ($level['code'] === 'B1')
                                <span class="absolute right-5 top-5 rounded bg-gold px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-navy">Популярно</span>
                            @endif
    ...
    <section id="vocabulary" class="bg-armor py-20 sm:py-28">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex flex-wrap items-end justify-between gap-4" data-reveal>
                <div>
                    <p class="text-xs font-bold uppercase tracking-[0.2em] text-brand">Словарь</p>
                    <h2 class="mt-3 font-display text-[32px] font-semibold text-ink sm:text-[38px]">Учи слова с контекстом</h2>
                </div>
                <a href="{{ route('register') }}" class="hidden items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-brand sm:inline-flex">Весь словарь <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.6"><path d="M5 12h14M13 5l7 7-7 7" /></svg></a>
            </div>
                ...
                <div class="flip-card mx-auto h-56 w-72 cursor-pointer" id="homeFlashcard" data-reveal>
                    <div class="flip-card-inner h-full w-full">
                        ...
                        <div class="flip-face flip-back flex h-full flex-col items-center justify-center rounded-2xl bg-navy p-6 text-center text-white shadow-softLg">
                            <p class="text-[11px] font-bold uppercase tracking-widest text-gold">Перевод</p>
                            <p class="mt-3 font-display text-[23px] font-semibold">страсть к путешествиям</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="bg-armor2 py-20 sm:py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div data-reveal class="grid items-center gap-10 rounded-2xl border border-line bg-armor p-8 shadow-soft sm:p-12 lg:grid-cols-2">
                <div>
                    <span class="inline-flex items-center gap-2 rounded-full bg-brand/10 px-3.5 py-1.5 text-[11px] font-bold uppercase tracking-wider text-brand">AI-помощник</span>
                    <h2 class="mt-4 font-display text-[26px] font-semibold text-ink sm:text-[32px]">Знакомься, это <span class="text-brand">Phil</span></h2>
    ...
    <section id="achievements" class="bg-navy py-20 sm:py-28">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center" data-reveal>
                <p class="text-xs font-bold uppercase tracking-[0.2em] text-gold">Мотивация</p>
                <h2 class="mt-3 font-display text-[32px] font-semibold text-white sm:text-[38px]">Учёба, в которую хочется возвращаться</h2>
                <div class="mx-auto mt-4 h-[3px] w-14 bg-gradient-to-r from-[#C9A961] to-[#D4AF37]"></div>
                <p class="mt-4 text-[16px] text-white/60">Собирай награды за streak, пройденные темы и новые слова.</p>
            </div>
    ...
    <section class="bg-gradient-to-br from-[#C9A961] to-[#D4AF37] py-20 text-center sm:py-24">
        <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8" data-reveal>
            <h2 class="font-display text-[28px] font-semibold text-navy sm:text-[36px]">Готов заговорить свободно?</h2>
            <p class="mx-auto mt-3 max-w-md text-[15.5px] text-navy/70">Присоединяйся бесплатно — первые уроки открыты для всех.</p>
