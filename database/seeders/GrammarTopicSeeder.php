    ...
    private function topics(): array
    {
        return [
            ...
            [
                ...
                'title' => 'Глагол to be (Be)',
                'category' => 'Verbs and Voices',
                'theory' => "Глагол to be — самый важный и самый неправильный глагол в английском языке. Он используется как смысловой глагол (описывает состояние, качество, профессию) и как вспомогательный глагол (в Continuous и Passive).\n\nКогда используется:\n— как смысловой глагол: описание состояния, качества, возраста, профессии, местонахождения: I am tired. She is a teacher. They are in London.\n— как вспомогательный глагол в Continuous-временах: I am reading. She was cooking.\n— как вспомогательный глагол в Passive Voice: The letter was sent yesterday.\n— в конструкции there is/are для указания на существование: There is a cat on the roof.\n\nФормы:\nPresent: I am (I'm), he/she/it is (he's/she's/it's), you/we/they are (you're/we're/they're). Past: I/he/she/it was, you/we/they were. Participle: been (Perfect), being (Continuous/Passive).\n\nПримеры:\nI am a student. He is not (isn't) at home. Are you ready? They were very happy. Where were you yesterday? We have been friends for years. The window was broken by the storm.\n\nДополнительные примеры:\nShe isn't from Spain, is she? I was being careful. It's cold today. Was the film good? They aren't coming tonight. Being late is not acceptable.\n\nЧастые ошибки:\n— Пропуск глагола to be там, где в русском языке связка опускается: 'She teacher' — неправильно, нужно 'She is a teacher'.\n— be вместо am/is/are/was/were в спрягаемой форме: 'I be tired' — неправильно (кроме особых случаев imperative/subjunctive), нужно 'I am tired'.",
            ],
            [
                'level' => 'A1',
            ...
            [
                ...
                'category' => 'Verbs and Voices',
                'theory' => "Passive Voice используется, когда важнее сам факт действия или его результат, а не то, кто его совершил — исполнитель действия либо неизвестен, либо неважен, либо намеренно опускается.\n\nКогда используется:\n— исполнитель неизвестен или неважен: The window was broken (кем — неизвестно/неважно).\n— исполнитель очевиден из контекста: The president was elected in 2020.\n— в формальном, научном и новостном стиле, где фокус на процессе, а не на исполнителе: The results were published last month.\n— чтобы подчеркнуть объект действия, а не субъект: My car was stolen last night.\n\nСтруктура:\nbe (в нужном времени) + причастие прошедшего времени (Participle II). Исполнитель, если нужен, добавляется через by: The book was written by Tolstoy.\nPresent Simple Passive: The house is cleaned every week. Past Simple Passive: The letter was sent yesterday. Present Perfect Passive: The work has been finished. Future Passive: The report will be published soon. Modal Passive: The task must be completed today.\n\nПримеры:\nEnglish is spoken all over the world. The bridge was built in 1889. Millions of copies have been sold. The problem is being investigated. The decision will be made next week. This rule must be followed by everyone.\n\nДополнительные примеры:\nThe cake was eaten before I got home. New laws are being introduced this year. The museum has been closed for renovation. The email should be sent by Friday. Coffee is grown in many tropical countries.\n\nЧастые ошибки:\n— Пропуск be: 'The letter sent yesterday' — неправильно, нужно 'The letter was sent yesterday'.\n— Использование начальной формы глагола вместо причастия: 'The window was break' — неправильно, нужно 'The window was broken'.\n— Образование passive от непереходных глаголов (без прямого дополнения): непереходные глаголы (arrive, happen, exist) не имеют пассивной формы.",
            ],
            [
                'level' => 'B1',
            ...
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Модальные глаголы (Modals)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Modal verbs (can, could, may, might, will, would, shall, should, must) — особая группа вспомогательных глаголов, которые выражают отношение говорящего к действию: возможность, необходимость, разрешение, совет, предположение — а не само действие.\n\nКогда используется:\n— умение и возможность: can, could, be able to.\n— разрешение: can, could, may, might.\n— совет и рекомендация: should, ought to, had better.\n— необходимость и обязанность: must, have to, need to.\n— предположение и вероятность: may, might, could, must, can't.\n— просьбы и предложения: can, could, will, would, shall.\n\nФормы (главная особенность модальных глаголов):\nне меняются по лицам (без -s в 3-м лице: he can, не he cans), после них смысловой глагол стоит в начальной форме без to (she must go, не to go), не используются с do/does/did в вопросах и отрицаниях (Can you swim?, не Do you can swim?), не имеют форм Continuous/Perfect/Infinitive в чистом виде.\n\nПримеры:\nShe can speak three languages. You must wear a seatbelt. It might rain later. Could you help me, please? You should see a doctor. Shall we dance?\n\nДополнительные примеры:\nHe can't be at home — I just saw him at work. We may go to the concert tonight. You needn't worry about the exam. They must have left already. Would you like some tea?\n\nЧастые ошибки:\n— do-support с модальными глаголами: 'Do you can swim?' — неправильно, нужно 'Can you swim?'.\n— to-infinitive после модального глагола: 'You must to go' — неправильно, нужно 'You must go' (кроме ought to и have to, которые формально являются semi-modals, см. отдельную тему).",
            ],
            [
                'level' => 'A1',
            ...
            [
                'level' => 'A1',
                'lesson' => '',
                'title' => 'Глаголы в английском языке (Verbs)',
                'category' => 'Verbs and Voices',
                'theory' => "Глагол (verb) — часть речи, которая описывает действие, состояние или процесс. Глагол — центр английского предложения: от его формы зависят время, залог, лицо и число.\n\nКогда используется:\n— чтобы описать физическое действие: run, eat, write.\n— чтобы описать состояние или чувство: know, love, believe.\n— чтобы связать подлежащее с его признаком (linking verbs): be, seem, become.\n— как вспомогательный элемент для построения времён и вопросов: do, be, have.\n\nФормы (основные типы глаголов, рассматриваемые в этой категории):\nпо регулярности форм: Regular and Irregular Verbs; по значению: Action and State Verbs; по функции: Auxiliary Verbs, Linking Verbs; по переходности: Transitivity, Transitive/Intransitive/Ditransitive Verbs; по структуре: Phrasal Verbs, Catenative Verbs.\n\nПримеры:\nShe runs every morning. I know the answer. He seems tired. They have finished the project. Do you like tea? We were walking home.\n\nДополнительные примеры:\nThe children play in the garden. I believe you. This soup tastes delicious. She has been working here for years. Did you call me?\n\nЧастые ошибки:\n— Пропуск глагола в предложении: в английском (в отличие от русского) почти всегда нужен явный глагол-сказуемое, даже там, где по-русски связка опускается.\n— Смешение времени, залога и наклонения глагола — это три разные грамматические категории (когда происходит действие / кто его совершает / как говорящий относится к нему), см. отдельные темы этой категории и категории Moods.",
            ],
            [
                'level' => 'A1',
                'lesson' => '',
                'title' => 'Правильные и неправильные глаголы (Regular and Irregular Verbs)',
                'category' => 'Verbs and Voices',
                'theory' => "Regular verbs образуют прошедшее время и причастие прошедшего времени по стандартному правилу (+ -ed), а irregular verbs имеют особые, часто исторически сложившиеся формы, которые нужно запоминать отдельно.\n\nКогда используется:\n— правильные глаголы: work → worked → worked; play → played → played.\n— неправильные глаголы: go → went → gone; write → wrote → written; be → was/were → been.\n— форма прошедшего времени (Past Simple) и причастия (Participle II) у правильных глаголов совпадают, у неправильных — часто различаются.\n\nФормы (правило для regular verbs):\nглагол + -ed: work → worked. Оканчивается на -e: + -d: like → liked. Согласная + -y: -y → -ied: study → studied. Краткий гласный + согласная (ударный слог): согласная удваивается: stop → stopped.\n\nПримеры:\nI walked to school. She studied all night. He stopped the car. I saw a great film yesterday (see → saw). They went home early (go → went). We have eaten dinner already (eat → ate → eaten).\n\nДополнительные примеры:\nShe played the piano beautifully. He has broken his arm (break → broke → broken). I bought a new phone (buy → bought). They have written three books (write → wrote → written). The children cried all night.\n\nЧастые ошибки:\n— Добавление -ed к неправильным глаголам: 'goed', 'writed' — неправильно, нужно went, wrote.\n— Использование Past Simple формы вместо Participle II в Perfect-временах: 'I have went' — неправильно, нужно 'I have gone' (went — это Past Simple, а не причастие).",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Глаголы действия и состояния (Action and State Verbs)',
                'category' => 'Verbs and Voices',
                'theory' => "Action verbs (dynamic verbs) описывают физическое или изменяющееся действие, а state verbs (stative verbs) описывают состояние, чувство, мнение или отношение, которое обычно не меняется момент за моментом.\n\nКогда используется:\n— action verbs свободно используются в Continuous-временах: She is running.\n— state verbs (know, believe, love, want, own, understand, seem) обычно НЕ используются в Continuous-временах, а стоят в Simple: I know the answer (не 'I am knowing').\n— некоторые глаголы (think, have, see) могут быть и state, и action в зависимости от значения: I think it's true (мнение, state) vs I'm thinking about it (процесс, action).\n\nФормы (основные группы state verbs):\nмысли и мнения: know, believe, think, understand, remember. чувства и эмоции: love, hate, like, want, need, prefer. восприятие: see, hear, smell, taste. обладание: have, own, belong. другие: seem, appear, cost, weigh, contain.\n\nПримеры:\nI understand the problem. She loves chocolate. This bag belongs to me. He seems very tired. The box weighs five kilos. I'm cooking dinner right now.\n\nДополнительные примеры:\nWe own a small house in the countryside. Do you believe him? I'm thinking about changing my job. This cake tastes amazing. She's tasting the soup to check the salt (действие — пробовать на вкус).\n\nЧастые ошибки:\n— State verb в Continuous без смены значения: 'I am knowing the answer' — неправильно, нужно 'I know the answer'.\n— Игнорирование двойного значения глаголов типа think/have/see: важно определить, идёт ли речь о мнении/состоянии (Simple) или о процессе/действии (Continuous).",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Вспомогательные глаголы (Auxiliary Verbs)',
                'category' => 'Verbs and Voices',
                'theory' => "Auxiliary verbs (вспомогательные глаголы) сами по себе не несут основного лексического значения, а помогают образовывать времена, вопросы, отрицания и залог вместе со смысловым глаголом.\n\nКогда используется:\n— be — для Continuous-времён и Passive Voice: She is working. The house was built in 1990.\n— have — для Perfect-времён: I have finished. She had already left.\n— do/does/did — для вопросов и отрицаний в Present/Past Simple: Do you like tea? I don't know. Did she call?\n— модальные глаголы (can, must, will, should и др.) также функционируют как вспомогательные, выражая возможность, необходимость, будущее время.\n\nФормы:\nbe: am/is/are, was/were, been, being. have: have/has, had. do: do/does, did.\n\nПримеры:\nI am reading a book. She has finished her homework. Do you speak English? We didn't go to the party. He was invited to the wedding. They have been waiting for an hour.\n\nДополнительные примеры:\nDoes she work here? I haven't seen him today. The cake is being baked. Did you enjoy the film? We had already eaten when they arrived. Is it raining outside?\n\nЧастые ошибки:\n— Использование do/does/did вместе со смысловым глаголом to be: 'Does she is happy?' — неправильно, нужно 'Is she happy?' (to be не требует do-support).\n— Пропуск вспомогательного глагола в отрицании/вопросе: 'I not like it' — неправильно, нужно 'I don't like it'.",
            ],
            [
                'level' => 'B2',
                'lesson' => 'Adjectives and Adverbs: Formation',
                'title' => 'Легкие глаголы (Light Verbs)',
                'category' => 'Verbs and Voices',
                'theory' => "Light verbs (или delexical verbs) — глаголы вроде have, make, take, do, give, которые почти теряют собственное лексическое значение и работают вместе с существительным, которое несёт основной смысл всей фразы.\n\nКогда используется:\n— вместо более редкого однословного глагола часто используется устойчивое сочетание light verb + noun: have a shower (= to shower), take a break (= to rest), make a decision (= to decide).\n— такие сочетания звучат более естественно и употребительно в разговорной речи, чем формальные однословные аналоги.\n\nФормы (частые сочетания):\nhave: have a look, have a chat, have a rest, have breakfast. make: make a decision, make an effort, make a mistake, make progress. take: take a break, take a photo, take a risk, take care. give: give a speech, give advice, give a hand. do: do a favour, do damage, do research.\n\nПримеры:\nLet's have a quick chat about the project. She made a huge effort to finish on time. Can you take a photo of us? He gave a great speech at the conference. I need to do some research before the meeting.\n\nДополнительные примеры:\nWe had a long discussion about the budget. They made good progress this month. Take care of yourself! Could you give me a hand with these bags? She did me a favour by covering my shift.\n\nЧастые ошибки:\n— Смешение light verbs: 'do a decision' — неправильно, нужно 'make a decision' (каждое существительное требует своего конкретного light verb, это нужно запоминать как устойчивое сочетание).\n— Использование однословного глагола там, где естественнее light-verb конструкция, и наоборот — оба варианта грамматически верны, но light-verb сочетания чаще звучат более разговорно и естественно.",
            ],
            [
                'level' => 'B1',
                'lesson' => '',
                'title' => 'Переходность глаголов (Transitivity)',
                'category' => 'Verbs and Voices',
                'theory' => "Transitivity (переходность) показывает, требует ли глагол прямое дополнение (объект действия) для завершённости смысла, и если да — сколько именно дополнений.\n\nКогда используется:\n— чтобы определить, нужен ли глаголу объект: transitive verbs требуют прямое дополнение (She reads a book — нельзя сказать просто 'She reads' в значении процесса чтения книги без контекста).\n— intransitive verbs не принимают прямое дополнение: She sleeps (нельзя добавить прямое дополнение: 'She sleeps a bed' неверно).\n— многие глаголы могут быть и переходными, и непереходными в зависимости от контекста: She reads (непереходно — процесс) / She reads books (переходно — с объектом).\n\nФормы (типы по переходности, разбираемые в этой категории):\nIntransitive Verbs (без дополнения), Monotransitive Verbs (одно прямое дополнение), Ditransitive Verbs (два дополнения), Complex Transitive Verbs (дополнение + его характеристика), Ergative Verbs (могут менять роль подлежащего/дополнения).\n\nПримеры:\nShe smiled. (intransitive) She wrote a letter. (monotransitive) She gave him a letter. (ditransitive) She painted the wall blue. (complex transitive) The door opened. / She opened the door. (ergative)\n\nДополнительные примеры:\nHe arrived late. (intransitive) He bought a car. (monotransitive) He told me a story. (ditransitive) They elected her president. (complex transitive) The glass broke. / He broke the glass. (ergative)\n\nЧастые ошибки:\n— Добавление дополнения к строго непереходному глаголу: 'He arrived the station' — неправильно, нужен предлог: 'He arrived at the station' (arrive — непереходный, требует предлог, а не прямое дополнение).\n— Пропуск обязательного дополнения у переходного глагола: 'She enjoys' без объекта звучит незавершённо, нужно 'She enjoys music/it'.",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Непереходные глаголы (Intransitive Verbs)',
                'category' => 'Verbs and Voices',
                'theory' => "Intransitive verbs — глаголы, которые НЕ принимают прямое дополнение: действие само по себе завершено и не переходит на объект.\n\nКогда используется:\n— чтобы описать действие, не направленное на объект: She smiled. He sleeps.\n— часто описывают движение, состояние или процесс: arrive, go, come, fall, happen, exist, sleep, cry, laugh, die.\n— если нужно уточнить место/время/способ действия — используется наречие или предлог, а не прямое дополнение: He arrived at the airport (предлог at, не прямое дополнение).\n\nСтруктура:\nПодлежащее + intransitive verb (+ обстоятельство места/времени/образа действия, но НЕ прямое дополнение).\nThe sun rises in the east. She laughed loudly. He disappeared suddenly.\n\nПримеры:\nThe baby cried all night. He arrived yesterday. The old bridge collapsed. She smiled at me. Nothing happened. The flowers died because of the frost.\n\nДополнительные примеры:\nThey travelled to Spain last summer. The plane landed safely. My grandmother passed away last year. The children played in the park. The economy is growing steadily.\n\nЧастые ошибки:\n— Добавление прямого дополнения к строго непереходному глаголу: 'She laughed the joke' — неправильно, нужно 'She laughed at the joke' (нужен предлог).\n— Использование intransitive-глагола в пассивном залоге: непереходные глаголы обычно не образуют Passive Voice, потому что у них нет объекта, который мог бы стать подлежащим пассивного предложения.",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Связочные глаголы (Linking Verbs)',
                'category' => 'Verbs and Voices',
                'theory' => "Linking verbs (copular verbs) не описывают действие, а связывают подлежащее с его характеристикой — прилагательным или существительным, которое его описывает (subject complement).\n\nКогда используется:\n— чтобы описать состояние, качество или изменение подлежащего: She seems tired. He became a doctor.\n— после linking verbs используется прилагательное, а НЕ наречие, потому что описывается подлежащее, а не сам глагол: She looks happy (не happily).\n— основной linking verb — be; другие: seem, appear, become, get, remain, stay, look, feel, sound, smell, taste.\n\nСтруктура:\nПодлежащее + linking verb + прилагательное/существительное (subject complement).\nThe soup smells delicious. He became famous. She remained calm during the crisis.\n\nПримеры:\nThis cake tastes amazing. He looks exhausted. The milk has gone bad. She seems very confident. They stayed friends for years. The room feels cold.\n\nДополнительные примеры:\nThe weather turned cold suddenly. Your plan sounds interesting. He got angry very quickly. The leaves are turning yellow. She appears nervous about the interview.\n\nЧастые ошибки:\n— Наречие вместо прилагательного после linking verb: 'She looks beautifully' — неправильно, нужно 'She looks beautiful' (описывается she, а не look).\n— Путаница linking verb с action verb у одного и того же слова: 'She looked at the picture' (action — смотреть) vs 'She looked tired' (linking — выглядела).",
            ],
            [
                'level' => 'B1',
                'lesson' => '',
                'title' => 'Монопереходные глаголы (Monotransitive Verbs)',
                'category' => 'Verbs and Voices',
                'theory' => "Monotransitive verbs — переходные глаголы, которые принимают ровно ОДНО прямое дополнение (direct object) для завершённости смысла.\n\nКогда используется:\n— когда действие направлено на один объект без косвенного дополнения или дополнительной характеристики: She wrote a letter. He bought a car.\n— большинство переходных глаголов в английском языке (read, eat, buy, see, like, want) относятся именно к этому типу.\n\nСтруктура:\nПодлежащее + monotransitive verb + прямое дополнение.\nI read the newspaper. She likes chocolate. He fixed the car.\n\nПримеры:\nShe closed the door. I saw a beautiful bird. They built a new house. He plays the guitar. We watched a great film. She wants a new phone.\n\nДополнительные примеры:\nI finished my homework. He caught the ball. She wrote a poem. They visited their grandparents. The company launched a new product.\n\nЧастые ошибки:\n— Пропуск обязательного прямого дополнения: 'I bought' без объекта звучит незавершённо, нужно 'I bought a car'.\n— Путаница с ditransitive: monotransitive имеет только ОДНО дополнение, а не два (сравните 'She wrote a letter' — monotransitive, и 'She wrote him a letter' — ditransitive, с добавленным косвенным дополнением).",
            ],
            [
                'level' => 'B1',
                'lesson' => '',
                'title' => 'Двупереходные глаголы (Ditransitive Verbs)',
                'category' => 'Verbs and Voices',
                'theory' => "Ditransitive verbs принимают ДВА дополнения: прямое (direct object — что дают/говорят/показывают) и косвенное (indirect object — кому).\n\nКогда используется:\n— с глаголами передачи и коммуникации: give, send, show, tell, offer, teach, buy, bring, lend.\n— когда важно указать и объект действия, и получателя: She gave him a present.\n\nСтруктура (два варианта порядка):\nПодлежащее + глагол + косвенное дополнение + прямое дополнение: She gave him a book.\nПодлежащее + глагол + прямое дополнение + to/for + косвенное дополнение: She gave a book to him.\n\nПримеры:\nHe sent her an email. I showed my friends the photos. She told us a secret. They offered him a job. Can you lend me some money? I bought my mother some flowers.\n\nДополнительные примеры:\nShe taught the children English. He passed me the salt. My uncle gave me some good advice. They sent us an invitation. Could you get me a glass of water?\n\nЧастые ошибки:\n— Неверный порядок дополнений с местоимением: 'She gave to him a book' звучит неестественно рядом с местоимением, обычно естественнее 'She gave him a book' или 'She gave a book to him'.\n— Пропуск предлога to/for при обратном порядке: 'She gave a book him' — неправильно, нужно 'She gave a book to him'.",
            ],
            [
                'level' => 'B2',
                'lesson' => '',
                'title' => 'Комплексно-переходные глаголы (Complex Transitive Verbs)',
                'category' => 'Verbs and Voices',
                'theory' => "Complex transitive verbs принимают прямое дополнение И его характеристику (object complement) — слово или фразу, которая описывает или переименовывает это дополнение.\n\nКогда используется:\n— чтобы показать, каким стало или считается дополнение в результате действия: They made her happy. We elected him president.\n— частые глаголы этого типа: make, call, name, elect, consider, find, keep, paint.\n\nСтруктура:\nПодлежащее + глагол + прямое дополнение + object complement (прилагательное или существительное).\nWe painted the wall blue. They named the baby Sophie. I consider him a good friend.\n\nПримеры:\nThe news made her sad. They elected her class president. We call him Tommy. I find this book quite boring. Keep the door open, please. They consider the plan risky.\n\nДополнительные примеры:\nThe team named him captain. This song makes me happy. I found the lecture fascinating. They painted the fence white. She keeps her room tidy.\n\nЧастые ошибки:\n— Добавление лишнего to be перед object complement: 'They made her to be happy' — неправильно, нужно 'They made her happy'.\n— Путаница с ditransitive: в complex transitive второй элемент ОПИСЫВАЕТ первое дополнение (they made her happy = she is happy), а не является отдельным получателем действия, как в ditransitive.",
            ],
            [
                'level' => 'C1',
                'lesson' => '',
                'title' => 'Эргативные глаголы (Ergative Verbs)',
                'category' => 'Verbs and Voices',
                'theory' => "Ergative verbs — особая группа глаголов, которые могут быть и переходными, и непереходными, при этом объект переходного варианта становится подлежащим непереходного варианта, а само событие остаётся тем же.\n\nКогда используется:\n— переходный вариант: подлежащее совершает действие над объектом: She broke the window.\n— непереходный вариант: то, что было объектом, становится подлежащим, а исполнитель не указан: The window broke.\n— частые ergative verbs: break, open, close, start, stop, change, melt, boil, increase, decrease, improve.\n\nФормы:\n[Кто-то] + ergative verb + объект → [Объект] + тот же ergative verb (без исполнителя).\nHe opened the door. → The door opened. She started the engine. → The engine started.\n\nПримеры:\nThe ice melted in the sun. (сравните: The sun melted the ice.) Prices increased last year. (Someone increased prices.) The water is boiling. (She is boiling the water.) The situation improved. (New policies improved the situation.)\n\nДополнительные примеры:\nThe shop closes at 9 p.m. / He closes the shop at 9 p.m. The meeting started late. / They started the meeting late. Traffic increased sharply. / New roads increased traffic.\n\nЧастые ошибки:\n— Использование Passive Voice там, где нужен просто непереходный ergative-вариант: 'The window was broken by itself' звучит неестественно, естественнее просто 'The window broke'.\n— Путаница ergative verbs с обычными intransitive verbs: у ergative-глаголов подлежащее непереходного варианта — это ТОТ ЖЕ объект, что и дополнение переходного варианта, а не отдельный самостоятельный деятель.",
            ],
            [
                'level' => 'C1',
                'lesson' => '',
                'title' => 'Цепочечные глаголы (Catenative Verbs)',
                'category' => 'Verbs and Voices',
                'theory' => "Catenative verbs — глаголы, которые могут соединяться друг с другом в цепочку, где один глагол управляет формой следующего (to-infinitive, gerund или начальная форма без to).\n\nКогда используется:\n— чтобы построить цепочку из двух и более глаголов, где каждый следующий зависит от предыдущего: I want to learn to swim. She keeps forgetting to call.\n— конкретный catenative verb требует определённой формы следующего глагола — это нужно запоминать индивидуально для каждого глагола (см. также тему Gerund vs Infinitive).\n\nФормы:\n+ to-infinitive: want to, decide to, hope to, promise to, agree to. + gerund (-ing): keep, enjoy, avoid, finish, suggest. + начальная форма без to (после модальных и after let/make/help): can go, let him speak, make her cry.\n\nПримеры:\nI want to travel more. She decided to change her job. He keeps making the same mistake. They agreed to help us. We enjoy watching old films. Let it go.\n\nДополнительные примеры:\nI hope to see you soon. She avoids eating sugar. He managed to finish on time. They promised to call back. My parents let me stay out late. This cream helps reduce redness.\n\nЧастые ошибки:\n— Неверная форма после catenative verb: 'I enjoy to swim' — неправильно, нужно 'I enjoy swimming' (enjoy требует герундий, а не to-infinitive).\n— Слишком длинные, неестественные цепочки глаголов в устной речи — на практике редко строят больше 2-3 глаголов подряд.",
            ],
            [
                'level' => 'B1',
                'lesson' => 'Causative: Have/Get Something Done',
                'title' => 'Каузативные конструкции (Causatives)',
                'category' => 'Verbs and Voices',
                'theory' => "Causative verbs показывают, что подлежащее не выполняет действие само, а организует, чтобы кто-то другой выполнил его — «заставить/попросить/дать возможность что-то сделать».\n\nКогда используется:\n— have/get something done — когда услугу выполняет кто-то другой (часто профессионал): I had my hair cut. She got her car repaired.\n— make someone do something — заставить кого-то сделать что-то: The teacher made us stay after class.\n— let someone do something — разрешить: My parents let me travel alone.\n— have/get someone to do something — попросить/убедить: I got him to help me with the boxes.\n\nСтруктура (have/get something done):\nhave/get + объект + Participle II (причастие прошедшего времени).\nI had my house painted. She's getting her nails done.\n\nПримеры:\nHe had his car washed yesterday. We're having the kitchen renovated. She got her phone fixed. The teacher made the students rewrite the essay. My boss let me leave early. I got my sister to lend me some money.\n\nДополнительные примеры:\nThey had their photo taken at the wedding. I need to get this dress altered. My parents made me apologise. The security guard let us in without a ticket. She had her essay checked by a native speaker.\n\nЧастые ошибки:\n— Использование to-infinitive после make/let: 'They made me to clean' — неправильно, нужно 'They made me clean' (make и let требуют начальную форму без to).\n— Неверная форма причастия в have/get something done: 'I had my hair cutting' — неправильно, нужно 'I had my hair cut' (нужно Participle II, а не -ing).",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Возвратные глаголы (Reflexive Verbs)',
                'category' => 'Verbs and Voices',
                'theory' => "Reflexive verbs используются с возвратными местоимениями (myself, yourself, himself и т.д.), когда подлежащее и объект действия — одно и то же лицо: субъект выполняет действие над самим собой.\n\nКогда используется:\n— когда действие направлено на самого исполнителя: She hurt herself while cooking.\n— с некоторыми глаголами, где возвратное местоимение обязательно или меняет смысл: enjoy yourself, behave yourself, introduce myself.\n— для усиления (эмфазы), даже если действие не направлено на себя: I did it myself (сама, без чьей-либо помощи).\n\nФормы:\nmyself, yourself, himself, herself, itself, ourselves, yourselves, themselves.\n\nПримеры:\nI cut myself while chopping vegetables. Be careful, you might hurt yourself. He introduced himself to the group. Did you enjoy yourselves at the party? She talks to herself sometimes. They blame themselves for the mistake.\n\nДополнительные примеры:\nThe cat is washing itself. Please help yourself to some food. I taught myself to play guitar. We really enjoyed ourselves on holiday. He looked at himself in the mirror.\n\nЧастые ошибки:\n— Лишнее возвратное местоимение с глаголами, которые в английском не являются reflexive (в отличие от русского): 'I feel myself good' — неправильно, нужно просто 'I feel good'.\n— Неверный выбор местоимения по числу/лицу: 'They hurt himself' — неправильно, нужно 'They hurt themselves'.",
            ],
            [
                'level' => 'A2',
                'lesson' => 'Phrasal Verbs: Everyday Actions',
                'title' => 'Фразовые глаголы (Phrasal Verbs)',
                'category' => 'Verbs and Voices',
                'theory' => "Phrasal verbs — сочетания глагола с одной или двумя частицами (предлогом и/или наречием), которые вместе создают новое значение, часто далёкое от значения исходного глагола.\n\nКогда используется:\n— очень часто в разговорной речи вместо более формального однословного глагола: give up (= to quit), find out (= to discover).\n— некоторые phrasal verbs разделяемые (separable) — частица может стоять после объекта: turn the light off / turn off the light.\n— некоторые неразделяемые (inseparable) — частица всегда сразу после глагола: look after the children (не 'look the children after').\n\nФормы:\nглагол + частица (adverb): give up, look up, come back. глагол + предлог: look after, deal with, rely on. глагол + частица + предлог (трёхчастные): look forward to, put up with, get on with.\n\nПримеры:\nI gave up smoking last year. Can you turn off the lights? She looks after her little brother. We need to find out the truth. I'm looking forward to the holidays. He put up with a lot of stress at work.\n\nДополнительные примеры:\nPlease fill in this form. The plane took off on time. I ran into an old friend yesterday. They called off the meeting. She's trying to get over her cold. Don't give up on your dreams.\n\nЧастые ошибки:\n— Разделение неразделяемого phrasal verb: 'look the children after' — неправильно, нужно 'look after the children'.\n— Постановка местоимения после частицы в разделяемых phrasal verbs: 'turn off it' — неправильно, нужно 'turn it off' (местоимение всегда встаёт между глаголом и частицей).",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Залоги глагола (Voices)',
                'category' => 'Verbs and Voices',
                'theory' => "Voice (залог) показывает отношение между подлежащим и действием: выполняет ли подлежащее действие само (active voice) или испытывает его на себе (passive voice).\n\nКогда используется:\n— active voice — стандартный, самый частый залог: подлежащее — исполнитель действия: The chef cooked the meal.\n— passive voice — используется, когда важнее объект действия, а исполнитель неизвестен, неважен или очевиден: The meal was cooked (by the chef).\n\nФормы:\nActive: подлежащее + глагол (+ объект): She wrote the report. Passive: объект становится подлежащим + be + Participle II (+ by + исполнитель): The report was written (by her).\n\nПримеры:\nThe company launched a new product. → A new product was launched (by the company). Someone stole my bike. → My bike was stolen. Scientists have discovered a new planet. → A new planet has been discovered.\n\nДополнительные примеры:\nThey are building a new bridge. → A new bridge is being built. The chef will prepare the meal. → The meal will be prepared. People speak Spanish in many countries. → Spanish is spoken in many countries.\n\nЧастые ошибки:\n— Использование passive voice там, где исполнитель важен и уже известен из контекста — active voice обычно звучит естественнее и прямее.\n— Образование passive от непереходных глаголов, у которых нет прямого объекта (arrive, happen, exist) — такие глаголы не имеют пассивной формы.",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Действительный залог (Active Voice)',
                'category' => 'Verbs and Voices',
                'theory' => "Active Voice — основной, самый естественный залог английского языка, в котором подлежащее само выполняет действие, выраженное глаголом.\n\nКогда используется:\n— когда важно, КТО совершает действие: The dog chased the cat.\n— в подавляющем большинстве повседневной речи — active voice звучит прямее, короче и естественнее passive voice.\n— в инструкциях, рассказах и большинстве стилей письма, где важна ясность и динамика.\n\nСтруктура:\nПодлежащее (исполнитель) + глагол + дополнение (объект действия, если есть).\nThe teacher explained the rule. Birds build nests. My sister is reading a novel.\n\nПримеры:\nThe chef cooked a delicious meal. Millions of people watched the final. The company will launch the product next month. Scientists have discovered a new species. She is writing a letter.\n\nДополнительные примеры:\nMy father repaired the car himself. The students submitted their essays on time. The storm damaged several houses. Our team won the championship. The government introduced new taxes.\n\nЧастые ошибки:\n— Чрезмерное использование passive voice там, где active voice было бы яснее и естественнее — хороший стиль письма обычно предпочитает active voice, если исполнитель известен и важен.\n— Путаница подлежащего и дополнения при переводе с русского, где порядок слов свободнее: в английском именно подлежащее (первое слово перед глаголом) обычно является исполнителем действия в active voice.",
            ],
            [
                'level' => 'C1',
                'lesson' => '',
                'title' => 'Устаревшее спряжение глаголов (Archaic Verb Conjugation)',
                'category' => 'Verbs and Voices',
                'theory' => "Archaic verb conjugation — устаревшие формы глаголов и местоимений (thou, thee, -est, -eth), которые вышли из повседневного употребления, но встречаются в классической литературе, Библии (King James Version), Шекспире и религиозных/поэтических текстах.\n\nКогда используется:\n— в цитатах из старинных текстов, молитвах, поэзии и исторической/фэнтезийной стилизации: Thou shalt not steal.\n— второе лицо единственного числа (thou = ты) отличалось от современного you, которое исторически было формой множественного числа/вежливого обращения.\n— глаголы в 3-м лице ед. числа настоящего времени принимали окончание -eth вместо -s: he speaketh (= he speaks), she loveth (= she loves).\n\nФормы:\nthou (ты, подлежащее) — thee (тебя, дополнение) — thy/thine (твой) — thyself (себя). Глагол 2-го лица ед. числа: + -est: thou speakest, thou hast (= you have), thou art (= you are). Глагол 3-го лица ед. числа: + -eth: he doeth (= he does), she goeth (= she goes).\n\nПримеры:\nThou art my friend. (= You are my friend.) What sayest thou? (= What do you say?) He knoweth the truth. (= He knows the truth.) Blessed art thou among women. Speak, for thy servant heareth.\n\nДополнительные примеры:\nWhither thou goest, I will go. Thou shalt love thy neighbour as thyself. Get thee behind me. Verily I say unto thee... All that glitters is not gold, quoth the wise man.\n\nЧастые ошибки:\n— Использование архаичных форм в современной разговорной или деловой речи — сегодня они звучат неуместно вне цитат, стилизации или поэзии.\n— Путаница thou/thee: thou — подлежащее (как ты), thee — дополнение (как тебя), подобно паре I/me в современном языке.",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Глагол do (Do)',
                'category' => 'Verbs and Voices',
                'theory' => "Глагол do используется в трёх разных ролях: как смысловой глагол (делать), как вспомогательный глагол для вопросов и отрицаний, и для эмфатического усиления утверждения.\n\nКогда используется:\n— как смысловой глагол (действие «делать»): I do my homework every evening.\n— как вспомогательный глагол (do-support) в вопросах и отрицаниях Present/Past Simple: Do you like tea? I don't understand. Did she call?\n— для эмфатического усиления утвердительного предложения: I do like your dress! She does understand, she's just shy.\n— в кратких ответах и tag questions: Yes, I do. You like coffee, don't you?\n\nФормы:\nPresent: do/does. Past: did. Participle: done. Отрицательные краткие формы: don't, doesn't, didn't.\n\nПримеры:\nDo you speak German? He doesn't eat meat. Did they arrive on time? I do enjoy classical music. She has done all her chores. What do you do for a living?\n\nДополнительные примеры:\nWe didn't know about the change. Does this bus go downtown? I do want to help, I'm just very busy. Have you done your homework? You don't say! (выражение удивления)\n\nЧастые ошибки:\n— do-support вместе с to be: 'Does she is a teacher?' — неправильно, нужно 'Is she a teacher?' (to be не требует do).\n— Пропуск do в вопросе Present Simple: 'You like tea?' грамматически неполно как формальный вопрос, нужно 'Do you like tea?'.",
            ],

            [
                'level' => 'B1',
                'lesson' => 'Modals of Deduction',
                'title' => 'Как говорить о предположениях (Talking About Deduction)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Modals of deduction (must, can't, might/may/could) используются, чтобы сделать логический вывод о том, насколько вероятно то или иное объяснение ситуации — на основе имеющихся фактов.\n\nКогда используется:\n— must — сильная уверенность, что что-то верно (положительный вывод): The lights are off — they must be asleep.\n— can't — сильная уверенность, что что-то НЕ верно: He can't be tired, he just woke up.\n— may/might/could — вывод возможен, но не уверен: She might be stuck in traffic.\n\nСтруктура:\nПро настоящее: must/can't/might + начальная форма глагола (или + be + прилагательное). Про прошлое: must/can't/might + have + Participle II.\nHe must be at work. She can't have forgotten — she never forgets.\n\nПримеры:\nYou must be exhausted after such a long trip. This can't be right — check it again. She might know the answer. They must have left already — the lights are off. He can't have finished the report so quickly.\n\nДополнительные примеры:\nThe streets are wet — it must have rained. He must be joking! She can't be serious. They could be on their way already. It might have been a mistake.\n\nЧастые ошибки:\n— mustn't вместо can't для отрицательного вывода: 'She mustn't be at home' — неправильно в значении вывода, нужно 'She can't be at home' (mustn't означает запрет, а не отрицательный вывод).\n— Пропуск have в выводе о прошлом: 'He must finished it' — неправильно, нужно 'He must have finished it'.",
            ],
            [
                'level' => 'B1',
                'lesson' => 'Giving Advice: Should, Ought to, If I Were You',
                'title' => 'Как давать советы (Giving Advice)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Для советов в английском языке используется несколько конструкций разной степени настойчивости — от мягкой рекомендации до сильного убеждения.\n\nКогда используется:\n— should/ought to — обычный совет: You should see a doctor.\n— had better — более настойчивый совет с оттенком предупреждения о последствиях: You'd better hurry, or you'll miss the train.\n— If I were you, I would... — вежливый совет от первого лица: If I were you, I would apologise.\n— why don't you...? / why not...? — совет в форме вопроса: Why don't you try again?\n\nСтруктура:\nshould/ought to + начальная форма глагола. had better + начальная форма глагола (без to). If I were you, I would + начальная форма глагола.\n\nПримеры:\nYou should exercise more often. You ought to apologise to her. You'd better leave now, it's getting late. If I were you, I'd take the job. Why don't you ask your teacher for help?\n\nДополнительные примеры:\nYou shouldn't stay up so late. He ought to be more careful. We'd better book the tickets in advance. If I were you, I wouldn't trust him. Why not try a different approach?\n\nЧастые ошибки:\n— to после had better: 'You had better to go' — неправильно, нужно 'You had better go'.\n— was вместо were в 'If I were you' — were считается более правильным и стандартным в этой устойчивой фразе, хотя was встречается в неформальной речи.",
            ],
            [
                'level' => 'B2',
                'lesson' => 'Modals of Speculation: Advanced',
                'title' => 'Как выражать предположения (Talking About Assumptions)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Talking about assumptions — использование модальных глаголов (must, may, might, could, should) для выражения разной степени уверенности в предположении о настоящем, прошлом или будущем.\n\nКогда используется:\n— почти полная уверенность: must (+), can't/couldn't (-).\n— умеренная уверенность, ожидание: should/ought to (предполагается, что всё идёт по плану): The package should arrive tomorrow.\n— неуверенное предположение: may/might/could: She may already know about it.\n\nСтруктура (про настоящее/будущее и про прошлое):\nmust/may/might/could/should + начальная форма (настоящее/будущее): He should be home by now.\nmust/may/might/could/should + have + Participle II (прошлое): She should have arrived by now — I wonder what happened.\n\nПримеры:\nThe meeting should start soon. He might be running late. She must know the truth by now. They could have missed the flight. The results should have been published already.\n\nДополнительные примеры:\nIt may rain later, so take an umbrella. He can't have said that — it's not like him. The train should be here any minute. She might have forgotten about our appointment.\n\nЧастые ошибки:\n— should для сильной уверенности вместо ожидания «по плану»: should выражает то, что ожидается при нормальном ходе событий, а не железную гарантию, в отличие от must.\n— Путаница must (положительный вывод) и mustn't (запрет, а не отрицательное предположение) — для отрицательного вывода нужен can't/couldn't.",
            ],
            [
                'level' => 'A2',
                'lesson' => 'Must and Have to',
                'title' => 'Must and Have to (обязанность)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Must и have to оба выражают обязанность, но различаются источником этой обязанности: must — личное мнение говорящего, have to — внешнее правило или обстоятельство.\n\nКогда используется:\n— must — обязанность, которую устанавливает сам говорящий, или сильная личная убеждённость: I must call my mother today.\n— have to — обязанность, установленная извне (правилами, законом, другим человеком): I have to wear a uniform at work.\n— в отрицании смысл сильно различается: mustn't = запрещено, don't have to = не обязательно (но можно).\n\nСтруктура:\nmust + начальная форма глагола (не меняется по лицам). have to / has to / had to + начальная форма глагола (спрягается как обычный глагол, использует do-support в вопросах/отрицаниях).\nYou must be quiet in the library. She has to work on Saturdays. Did you have to wait long?\n\nПримеры:\nWe must finish this report today. I have to renew my passport next month. Students must submit their essays by Friday. He had to cancel the trip because of the weather. You mustn't smoke here.\n\nДополнительные примеры:\nYou don't have to come if you're busy. Drivers must stop at a red light. Do you have to work this weekend? I mustn't forget my keys again. She has to take medicine every morning.\n\nЧастые ошибки:\n— mustn't вместо don't have to для «не обязательно»: 'You mustn't come if you're busy' — неправильно, звучит как запрет, нужно 'You don't have to come if you're busy'.\n— do-support с must: 'Do you must go?' — неправильно, нужно 'Must you go?' (must — истинный модальный глагол, не требует do).",
            ],
            [
                'level' => 'A1',
                'lesson' => 'Can and Can\'t',
                'title' => 'Can (умение, разрешение, просьба)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Can — один из самых частых модальных глаголов, который выражает умение, возможность, разрешение и используется в просьбах.\n\nКогда используется:\n— умение/способность: I can swim.\n— разрешение (неформальное): Can I open the window?\n— возможность в данный момент: It can get very cold here in winter.\n— просьба: Can you help me, please?\n\nСтруктура:\ncan + начальная форма глагола (без to). Отрицание: cannot/can't + начальная форма. Вопрос: Can + подлежащее + начальная форма?\nShe can play the piano. I can't come to the party. Can you drive?\n\nПримеры:\nHe can speak four languages. Can I borrow your pen? You can't park here. Can you pass the salt, please? Birds can fly, but penguins can't. We can meet tomorrow if you like.\n\nДополнительные примеры:\nCan I ask you a question? She can't swim very well. It can be difficult to find parking downtown. Can you hear me? Anyone can make mistakes.\n\nЧастые ошибки:\n— to после can: 'I can to swim' — неправильно, нужно 'I can swim'.\n— can для прошлых единичных достижений: для конкретного одного случая в прошлом лучше 'was able to' / 'managed to', а не could (could больше для общей способности в прошлом).",
            ],
            [
                'level' => 'B1',
                'lesson' => '',
                'title' => 'May (разрешение, возможность, пожелание)',
                'category' => 'Modals and Semi-modals',
                'theory' => "May — более формальный модальный глагол, чем can, который выражает разрешение, возможность и используется в устойчивых пожеланиях.\n\nКогда используется:\n— формальное разрешение: May I come in?\n— возможность (что-то может произойти): It may rain later.\n— формальные пожелания: May you have a long and happy life.\n— в официальных документах и правилах для разрешённых действий: Students may use calculators during the exam.\n\nСтруктура:\nmay + начальная форма глагола. Отрицание: may not (без сокращения mayn't в современном языке). Вопрос: May + подлежащее + начальная форма?\nYou may leave now. It may not be true. May I ask a question?\n\nПримеры:\nMay I use your phone, please? The train may be delayed due to bad weather. Visitors may not enter without a pass. May all your wishes come true. She may already know the news.\n\nДополнительные примеры:\nYou may sit wherever you like. It may take a few days to process your request. He may be right about this. Members may bring one guest. May the best team win!\n\nЧастые ошибки:\n— maybe (наречие, пишется слитно) вместо may be (модальный глагол + be, раздельно): 'She maybe at home' — неправильно, нужно 'She may be at home' или 'Maybe she is at home'.\n— may для конкретной просьбы в неформальной обстановке — обычно звучит слишком официально, в разговорной речи чаще used can/could.",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Should (совет, ожидание, обязанность)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Should — модальный глагол для советов, рекомендаций, ожиданий и мягкой моральной обязанности.\n\nКогда используется:\n— совет и рекомендация: You should drink more water.\n— ожидание, что что-то произойдёт при нормальном ходе событий: The bus should arrive in five minutes.\n— моральная обязанность или правильность действия: We should help those in need.\n— критика прошлого действия (should have + Participle II): You should have called me.\n\nСтруктура:\nshould + начальная форма глагола (настоящее/будущее). should have + Participle II (прошлое, сожаление/критика).\nYou should study more. He shouldn't eat so much sugar. You should have told me earlier.\n\nПримеры:\nYou should see a dentist about that tooth. The results should be ready by Friday. We should respect other people's opinions. I should have apologised sooner. She shouldn't work so hard.\n\nДополнительные примеры:\nYou should wear a helmet when cycling. The package should have arrived by now. They should be more careful with money. You shouldn't have said that. He should try harder next time.\n\nЧастые ошибки:\n— should для строгого запрета/обязанности вместо мягкого совета: should не такой категоричный, как must — для строгих правил используется must/have to.\n— Пропуск have в критике прошлого: 'You should told me' — неправильно, нужно 'You should have told me'.",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Can and Could (умение в настоящем и прошлом)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Can выражает умение или возможность в настоящем/будущем, а could — в прошлом, а также используется как более вежливая форма can в просьбах.\n\nКогда используется:\n— can — текущее умение: She can drive.\n— could — умение в прошлом (общая способность, не единичный случай): I could read when I was four.\n— could — вежливая просьба: Could you open the window, please?\n— could — возможность (менее уверенная, чем can): It could be dangerous.\n\nСтруктура:\ncan/could + начальная форма глагола. Отрицание: can't/couldn't. Про единичное достижение в прошлом вместо could используется was/were able to или managed to.\n\nПримеры:\nI can speak Spanish fluently. When I was young, I could run very fast. Could you help me with this bag? We were able to finish the project on time (не 'could finish' — единичный случай). It could rain tomorrow.\n\nДополнительные примеры:\nShe couldn't sleep last night because of the noise. Could I ask you something? Dolphins can communicate with each other. He could play chess at the age of five. This could be a great opportunity.\n\nЧастые ошибки:\n— could для одного конкретного успешного действия в прошлом: 'I could pass the exam yesterday' — неправильно, нужно 'I managed to pass the exam' или 'I was able to pass the exam'.\n— can для прошлого вместо could: 'When I was a child, I can swim' — неправильно, нужно 'I could swim'.",
            ],
            [
                'level' => 'B1',
                'lesson' => '',
                'title' => 'May and Might (разрешение и возможность)',
                'category' => 'Modals and Semi-modals',
                'theory' => "May и might оба выражают возможность и разрешение, но might обычно звучит немного менее уверенно/более гипотетично, чем may, особенно при разговоре о возможностях.\n\nКогда используется:\n— may — формальное разрешение и вероятная возможность: You may leave early today.\n— might — более слабая, неуверенная возможность: It might snow tonight.\n— might — вежливая, очень осторожная просьба или предложение: Might I suggest an alternative?\n— might have + Participle II — предположение о прошлом: She might have missed the bus.\n\nСтруктура:\nmay/might + начальная форма глагола (настоящее/будущее). may/might + have + Participle II (прошлое).\n\nПримеры:\nWe may go camping this weekend. It might rain, so take an umbrella just in case. You may use the computer in the library. He might not come to the party. They might have already left.\n\nДополнительные примеры:\nShe may know the answer to your question. I might be a bit late tonight. Students may ask questions at the end. It might have been a misunderstanding. May I have your attention, please?\n\nЧастые ошибки:\n— may not сокращают как mayn't в современном английском крайне редко — обычно пишут may not полностью.\n— Путаница may/might с can/could в значении разрешения: may/might звучат более формально и вежливо, чем can/could, особенно в письменной и официальной речи.",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Will and Would (будущее и вежливость)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Will выражает будущее время, решения в момент речи и готовность/обещание, а would используется для вежливых просьб, гипотетических ситуаций и повторяющихся действий в прошлом.\n\nКогда используется:\n— will — простое будущее время и спонтанные решения: I'll call you tomorrow. I'll help you with that.\n— will — обещания и готовность: I will always love you.\n— would — вежливая просьба или предложение: Would you like some coffee?\n— would — повторяющееся действие в прошлом (как привычка): When I was a child, I would visit my grandmother every summer.\n— would — гипотетические ситуации (в Conditional 2/3): I would help you if I had time.\n\nСтруктура:\nwill/would + начальная форма глагола. Сокращения: I'll, you'll, won't (will not), wouldn't (would not).\n\nПримеры:\nI'll be there in ten minutes. Will you marry me? Would you mind closing the door? We would often play outside until dark. I would love to visit Japan someday.\n\nДополнительные примеры:\nShe won't answer my calls. Would you like to join us for dinner? He said he would call back later. I'll never forget this day. They wouldn't listen to any advice.\n\nЧастые ошибки:\n— will в if-части условных предложений: 'If it will rain' — неправильно, нужно 'If it rains'.\n— would для единичного действия в прошлом вместо used to/Past Simple: для однократного факта в прошлом нужен Past Simple, would используется только для ПОВТОРЯЮЩИХСЯ действий.",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Shall and Should (предложение и совет)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Shall в современном английском используется в основном для предложений и вежливых вопросов (особенно с I/we), а should выражает совет, рекомендацию и ожидание.\n\nКогда используется:\n— shall — предложение сделать что-то вместе (Shall we...?): Shall we go for a walk?\n— shall — формальное будущее время (устаревающее, в основном с I/we в британском формальном стиле): I shall return.\n— should — совет: You should rest more.\n— should — сильное ожидание того, что должно произойти: The train should arrive on time.\n\nСтруктура:\nShall + I/we + начальная форма глагола? (вопрос-предложение). should + начальная форма глагола (совет/ожидание).\n\nПримеры:\nShall we order pizza tonight? Shall I open the window? You should apologise to her. The meeting should finish by 5 p.m. Shall we begin the presentation?\n\nДополнительные примеры:\nShall I help you with your bags? We shall overcome this challenge together (формально/торжественно). You should always wear a helmet. Should I call a doctor? They should have arrived by now.\n\nЧастые ошибки:\n— shall с you/he/she/they в современной разговорной речи звучит очень старомодно — вместо этого обычно используют will или другие конструкции.\n— Путаница shall (предложение) и should (совет) — это разные модальные глаголы с разными функциями, несмотря на похожее звучание.",
            ],
            [
                'level' => 'B1',
                'lesson' => '',
                'title' => 'Полумодальные глаголы (Semi-Modals)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Semi-modal verbs (need to, dare, used to, ought to, have to, be able to, be going to, had better) сочетают черты обычных модальных глаголов и обычных смысловых глаголов — они выражают модальное значение, но при этом могут спрягаться, использовать to-infinitive или требовать do-support.\n\nКогда используется:\n— need to / have to — необходимость, спрягаются как обычные глаголы: She needs to leave early. He has to work late.\n— be able to — умение (замена can в тех временах, где can не существует): I haven't been able to sleep well lately.\n— be going to — намерение/будущее по плану: We're going to visit Rome next year.\n— ought to / had better — совет/рекомендация, но с некоторыми синтаксическими особенностями настоящих модальных глаголов (без do-support).\n\nФормы (отличие от «настоящих» модальных глаголов):\ntrue modals (can, must, will...) — не меняются по лицам, не требуют to, не используют do-support. semi-modals — часто требуют to (need to, have to, ought to), спрягаются (needs, has), некоторые используют do-support (Do you need to go?).\n\nПримеры:\nI need to buy some milk. She doesn't need to worry. We're going to travel next summer. He hasn't been able to contact her. You'd better hurry up. They ought to apologise.\n\nДополнительные примеры:\nDo you have to leave so soon? I used to live in Berlin. She dared to ask the difficult question. Are you able to attend the meeting tomorrow? We're going to be late.\n\nЧастые ошибки:\n— to после true modal: 'You must to go' — неправильно (must — настоящий модальный глагол). Но to после semi-modal обязателен: 'She needs go' — неправильно, нужно 'She needs to go'.\n— Игнорирование do-support там, где он нужен для semi-modal: 'Need you go?' звучит устаревше в современном языке, обычнее 'Do you need to go?'.",
            ],
            [
                'level' => 'B1',
                'lesson' => '',
                'title' => 'Ought to and Had better (совет и рекомендация)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Ought to близко по значению к should (совет, моральная обязанность), а had better выражает более настойчивый совет с явным намёком на негативные последствия при невыполнении.\n\nКогда используется:\n— ought to — совет или то, что считается правильным (похоже на should, но немного более формально): You ought to thank her for the gift.\n— had better — сильная рекомендация «сейчас» с предупреждением о последствиях: You'd better finish this today, or you'll be in trouble.\n— had better обычно НЕ используется для общих советов на будущее — только для конкретной срочной ситуации.\n\nСтруктура:\nought to + начальная форма глагола (единственный semi-modal, требующий to). had better + начальная форма глагола (без to, несмотря на 'had').\nYou ought to see a doctor. We'd better leave now.\n\nПримеры:\nYou ought to apologise for being late. We had better hurry, or we'll miss the flight. He ought to know better than that. You'd better not tell anyone about this. Students ought to arrive on time.\n\nДополнительные примеры:\nYou'd better take an umbrella — it looks like rain. She ought to rest after such a long journey. We ought to call them and explain. You'd better start studying now, the exam is close.\n\nЧастые ошибки:\n— to после had better: 'You had better to leave' — неправильно, нужно 'You had better leave'.\n— had better для общих, некритичных советов на будущее — в таких случаях естественнее should/ought to, had better звучит слишком настойчиво и предупреждающе.",
            ],
            [
                'level' => 'B2',
                'lesson' => '',
                'title' => 'Dare and Need (осмеливаться и нуждаться)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Dare (осмеливаться) и need (нуждаться) — необычные глаголы, которые могут вести себя и как обычные смысловые глаголы (с do-support и to), и как настоящие модальные глаголы (без do-support и to), особенно в отрицаниях и вопросах.\n\nКогда используется:\n— как обычный глагол: He doesn't dare to speak. Do you need to leave?\n— как модальный глагол (более формально, обычно в отрицаниях): He daren't speak. You needn't worry.\n— dare в устойчивом выражении How dare you...! для возмущения: How dare you speak to me like that!\n\nФормы:\nОбычный глагол: dare/dares to, need/needs to (+ do-support в вопросах/отрицаниях). Модальный глагол: dare/need без -s, без to, без do-support (daren't, needn't).\n\nПримеры:\nI don't dare to ask him. I daren't ask him (более формально/литературно). You needn't apologise, it's not your fault. Does she need any help? How dare you say that to me!\n\nДополнительные примеры:\nHe didn't dare to complain. Nobody dared to interrupt the meeting. You needn't have worried — everything is fine (needn't have + Participle II = сделал ненужное действие). Do you need anything from the shop?\n\nЧастые ошибки:\n— Смешение двух моделей в одном предложении: 'He doesn't dare speak' (пропущен to при обычном употреблении) или 'He dares not to speak' (лишний to при модальном употреблении) — важно выбрать одну модель последовательно.\n— needn't вместо didn't need to для однократного прошлого действия, которое всё же было выполнено: needn't have + Participle II используется, когда действие было сделано зря, а didn't need to — когда его просто не делали.",
            ],
            [
                'level' => 'A2',
                'lesson' => 'Used to',
                'title' => 'Used to (привычка в прошлом)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Used to описывает повторяющиеся действия или состояния, которые были верны в прошлом, но больше не происходят/не верны в настоящем.\n\nКогда используется:\n— прошлые привычки, которые прекратились: I used to smoke, but I quit two years ago.\n— прошлые состояния, которые изменились: There used to be a cinema here.\n— НЕ используется для единичного действия в прошлом — только для повторяющегося или длительного состояния.\n\nСтруктура:\nused to + начальная форма глагола. Отрицание: didn't use to (без -d). Вопрос: Did you use to...?\nShe used to play tennis every weekend. He didn't use to like coffee. Did you use to live in Rome?\n\nПримеры:\nI used to be afraid of the dark. We used to go camping every summer. There used to be a shop on this corner. She didn't use to eat vegetables when she was young. Did you use to have long hair?\n\nДополнительные примеры:\nHe used to work as a chef before he became a teacher. They used to live next door to us. I didn't use to like spicy food, but now I love it. My grandfather used to tell wonderful stories.\n\nЧастые ошибки:\n— use to вместо used to в утверждении: 'I use to play football' — неправильно (в утверждении нужен -d), нужно 'I used to play football'.\n— used to для одного конкретного случая: 'Yesterday I used to go to the cinema' — неправильно, used to не подходит для единичного события, нужен просто Past Simple: 'Yesterday I went to the cinema'.\n— Путаница used to (привычка в прошлом) с be/get used to (привыкнуть к чему-либо, + gerund) — это разные конструкции с разным значением.",
            ],
            [
                'level' => 'B1',
                'lesson' => '',
                'title' => 'Как говорить о предсказаниях (Talking about Prediction)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Для предсказаний о будущем в английском используется несколько конструкций в зависимости от степени уверенности и от того, основано ли предсказание на текущих признаках.\n\nКогда используется:\n— will — уверенное предсказание, часто основанное на мнении, а не на видимых признаках: I think it will rain tomorrow.\n— be going to — предсказание на основе текущих признаков или доказательств: Look at those clouds — it's going to rain.\n— may/might/could — менее уверенное предсказание: It might rain later.\n— should/ought to — предсказание того, что ожидается при нормальном ходе событий: Prices should fall next year.\n\nСтруктура:\nwill/may/might/could/should + начальная форма глагола. be going to + начальная форма глагола.\n\nПримеры:\nI'm sure she will pass the exam. Look at the sky — it's going to snow. Ticket prices might increase next year. The team should win easily tonight. Robots will probably do more jobs in the future.\n\nДополнительные примеры:\nHe's going to be a great doctor one day. The economy could improve next year. I don't think it will be a problem. This new phone is going to be very popular. She might become the new manager.\n\nЧастые ошибки:\n— will там, где предсказание основано на явных текущих признаках: 'Look, she will fall!' в момент, когда падение уже видно, естественнее 'Look, she's going to fall!'.\n— Смешение уровней уверенности: will выражает высокую уверенность, might/could — низкую, важно выбирать модальный глагол по степени уверенности говорящего.",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Как говорить о готовности (Talking about Willingness)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Willingness (готовность или отказ что-то сделать) чаще всего выражается через will/won't, а также через глаголы want to, be willing to, refuse to.\n\nКогда используется:\n— готовность помочь или сделать что-то: I'll carry your bag for you.\n— отказ/нежелание (won't в значении «не хочет», а не просто будущее время): The car won't start.\n— формальная готовность: be willing to: She is willing to work overtime.\n— решительный отказ: refuse to: He refused to apologise.\n\nСтруктура:\nwill/won't + начальная форма глагола. be willing/unwilling to + начальная форма глагола.\n\nПримеры:\nI'll help you move house this weekend. She won't listen to any advice. He's willing to compromise on the price. My computer won't turn on. They refused to leave the building.\n\nДополнительные примеры:\nWe're happy to help if you need anything. The door won't open — it's stuck. He's always willing to lend a hand. She flatly refused to answer any questions. The dog won't stop barking.\n\nЧастые ошибки:\n— won't как простое будущее время вместо отказа: важно различать 'It won't rain tomorrow' (простое будущее) и 'The engine won't start' (won't = отказывается, упрямо не работает).\n— Использование will для предметов/механизмов в обычном будущем значении, когда на самом деле имеется в виду «не хочет работать» — в этом случае нужно won't именно в значении отказа.",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Как говорить об умениях (Talking about Abilities)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Ability (умение/способность) выражается через can, could и be able to — выбор зависит от времени и от того, идёт ли речь об общей способности или о конкретном единичном случае.\n\nКогда используется:\n— can — умение в настоящем: I can cook Italian food.\n— could — общая способность в прошлом: She could read before she started school.\n— was/were able to — конкретное единичное достижение в прошлом: We were able to escape just in time.\n— will be able to — умение в будущем: You'll be able to speak fluently after this course.\n— be able to — используется там, где у can нет нужной формы (инфинитив, Perfect): I'd like to be able to swim.\n\nСтруктура:\ncan/could + начальная форма глагола. (be) able to + начальная форма глагола.\n\nПримеры:\nHe can play the guitar really well. When she was young, she could climb any tree. We were able to find a solution at the last minute. I've never been able to draw well. You'll be able to drive once you pass the test.\n\nДополнительные примеры:\nCan you touch your toes without bending your knees? They could speak French fluently as children. After months of practice, she was able to run a marathon. He hasn't been able to sleep well lately.\n\nЧастые ошибки:\n— could для единичного успешного действия в прошлом: 'I could finish the race yesterday' — неправильно, нужно 'I was able to finish the race' или 'I managed to finish the race'.\n— can с формами, которых у него нет: 'I have canned to swim' — неправильно, у can нет Perfect-формы, нужно 'I have been able to swim' или переформулировать предложение.",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Как давать и просить разрешение (Giving and Asking for Permission)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Для разрешения используются can, could, may и might — они отличаются по степени формальности и вежливости.\n\nКогда используется:\n— can — неформальная просьба о разрешении: Can I sit here?\n— could — более вежливая просьба: Could I ask you something?\n— may — формальная просьба или официальное разрешение: May I come in?\n— be allowed to — для описания правил и разрешений в целом (в том числе для 3-го лица и других времён): Students are allowed to use dictionaries.\n\nСтруктура:\nCan/Could/May + I/we + начальная форма глагола? Ответы: Yes, of course. / Sure. / I'm afraid not. / Sorry, you can't.\n\nПримеры:\nCan I borrow your pen? Could I leave a bit early today? May I ask a question? You may use your phone during the break. Visitors are not allowed to take photos.\n\nДополнительные примеры:\nCould I possibly have a glass of water? May I be excused, please? Can we open the window? Employees are allowed to work from home twice a week. You can't park here — it's a no-parking zone.\n\nЧастые ошибки:\n— can вместо may в очень официальной обстановке (собеседование, деловая переписка) — may/could звучат вежливее и уместнее.\n— Путаница отказа: 'You mustn't' (запрещено, строгий запрет) звучит гораздо жёстче, чем 'I'm afraid you can't' — важно выбирать степень вежливости по ситуации.",
            ],
            [
                'level' => 'B1',
                'lesson' => '',
                'title' => 'Как говорить о возможности (Talking about Possibilities)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Possibility (возможность того, что что-то произойдёт или является правдой) выражается через may, might, could — они показывают, что говорящий не уверен на 100%.\n\nКогда используется:\n— возможность в настоящем/будущем: She might be at home right now. It could rain later.\n— возможность в прошлом: He may have missed the train.\n— теоретическая возможность (что-то в принципе может произойти): Anyone could make that mistake.\n\nСтруктура:\nmay/might/could + начальная форма глагола (настоящее/будущее). may/might/could + have + Participle II (прошлое).\n\nПримеры:\nWe might go to the beach this weekend, we haven't decided yet. She could be the one who left the message. It may take longer than expected. He might have forgotten about the meeting. Prices could rise next year.\n\nДополнительные примеры:\nThere could be a problem with the connection. It might not be a good idea to travel now. She may already have the information. This could change everything. They might be planning a surprise party.\n\nЧастые ошибки:\n— maybe (наречие) вместо may be (глагольная форма): 'She maybe right' — неправильно, нужно 'She may be right' или 'Maybe she is right'.\n— can вместо may/might/could для конкретной возможности в данный момент: can обычно выражает общую теоретическую возможность (Anyone can make mistakes), а не конкретную ситуацию прямо сейчас.",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Как говорить о необходимости (Talking about Necessity)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Necessity (необходимость) выражается через must, have to и need to — а отсутствие необходимости через don't have to и don't need to/needn't.\n\nКогда используется:\n— обязательность (что-то нужно сделать): You must submit the form by Friday.\n— необходимость по внешним причинам: I need to buy some groceries.\n— отсутствие необходимости (можно, но не обязательно): You don't need to bring anything, we have everything ready.\n— важно не путать отсутствие необходимости с запретом (mustn't).\n\nСтруктура:\nmust/need to/have to + начальная форма глагола. don't need to / don't have to / needn't + начальная форма глагола.\n\nПримеры:\nWe need to leave in ten minutes. You don't need to worry about the cost, it's covered. Passengers must fasten their seatbelts. You don't have to answer if you don't want to. I really need to talk to you.\n\nДополнительные примеры:\nDo we need to bring our own equipment? You needn't explain, I already understand. Employees must complete the training by next month. She doesn't have to work weekends anymore.\n\nЧастые ошибки:\n— mustn't вместо don't need to/don't have to: 'You mustn't pay now' в значении «не обязательно платить сейчас» — неправильно, mustn't означает запрет, нужно 'You don't need to pay now'.\n— need как модальный глагол (needn't) путают с обычным глаголом need to — обе формы существуют, но needn't более формальна и типична для британского английского.",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Как предлагать помощь (Making Offers)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Для предложения помощи, услуги или чего-либо в английском языке есть несколько устойчивых вежливых конструкций с модальными глаголами.\n\nКогда используется:\n— shall I...? — вежливое предложение сделать что-то для собеседника: Shall I open the window?\n— can/could I...? — предложение помощи: Can I help you with that?\n— would you like...? — вежливое предложение чего-либо: Would you like some tea?\n— I'll... — спонтанное решение помочь: I'll carry that for you.\n\nСтруктура:\nShall I/Can I + начальная форма глагола? Would you like + существительное/to + начальная форма глагола?\n\nПримеры:\nShall I make some coffee? Can I get you anything from the shop? Would you like a lift to the station? I'll help you carry those boxes. Would you like me to explain it again?\n\nДополнительные примеры:\nShall I call a taxi for you? Can I take your coat? Would you like to sit down? I'll take care of it, don't worry. Do you need a hand with your suitcase?\n\nЧастые ошибки:\n— Shall с you/he/she в предложении помощи — shall в этой функции обычно используется только с I/we; для других лиц лучше подходит can/could/would you like.\n— Путаница offers (предложение помощи другому) с requests (просьба о помощи для себя) — это противоположные по направлению речевые акты.",
            ],
            [
                'level' => 'A2',
                'lesson' => '',
                'title' => 'Как просить о чём-то (Making Requests)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Requests (просьбы) в английском строятся с помощью can, could, will, would — от неформального can до очень вежливого would you mind.\n\nКогда используется:\n— can you...? — неформальная просьба: Can you close the door?\n— could you...? — более вежливая просьба: Could you help me with this bag?\n— will you...? — прямая просьба, иногда чуть настойчивая: Will you turn down the music?\n— would you mind + gerund...? — очень вежливая просьба: Would you mind waiting a moment?\n\nСтруктура:\nCan/Could/Will/Would you + начальная форма глагола? Would you mind + -ing форма глагола?\n\nПримеры:\nCan you pass me the salt, please? Could you speak more slowly? Will you please be quiet? Would you mind closing the window? Could you possibly lend me your notes?\n\nДополнительные примеры:\nCan I ask you a favour? Could you give me a hand with this? Would you mind if I opened the window? Will you help me carry these bags? Could you tell me the way to the station?\n\nЧастые ошибки:\n— Ответ 'Yes, I would' на 'Would you mind...?' — неправильно по смыслу: 'Would you mind closing the door?' означает 'Не будете ли вы против закрыть дверь?', поэтому согласие выражается как 'No, not at all' / 'No problem', а не 'Yes'.\n— will you в слишком формальной обстановке — звучит менее вежливо, чем could/would, лучше использовать could/would в официальных ситуациях.",
            ],
            [
                'level' => 'B1',
                'lesson' => '',
                'title' => 'Как говорить о привычках (Talking about Habits)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Habits (привычки) можно описывать разными способами в зависимости от того, идёт ли речь о привычках в настоящем или в прошлом, и насколько раздражает говорящего это повторяющееся поведение.\n\nКогда используется:\n— Present Simple — обычная привычка в настоящем: I get up at seven every day.\n— will (для типичного, характерного поведения): She will often stay up late reading.\n— used to — привычка в прошлом, которая прекратилась: He used to bite his nails as a child.\n— would — повторяющееся действие в прошлом (не для состояний): We would spend every summer at the lake.\n— will/would + always — раздражающая, навязчивая привычка (с эмоциональным ударением): He will always leave his shoes in the hallway!\n\nСтруктура:\nused to / would + начальная форма глагола (только used to подходит и для состояний, would — только для действий).\n\nПримеры:\nI used to eat a lot of junk food, but now I eat healthily. My grandfather would tell the same stories every Christmas. She'll always find an excuse to be late! We used to live by the sea. He would practise the piano for hours every day.\n\nДополнительные примеры:\nThey used to argue about everything. My dad would take us fishing every weekend. You will keep interrupting me — it's really annoying! There used to be more trees in this park.\n\nЧастые ошибки:\n— would для описания прошлого состояния (а не действия): 'I would have a bike when I was young' — неправильно для владения/состояния, нужно 'I used to have a bike'.\n— will/would + always для нейтрального факта — эта конструкция специально подчёркивает раздражение/эмоцию, а не просто описывает частое действие.",
            ],
            [
                'level' => 'B2',
                'lesson' => '',
                'title' => 'Модальные выражения (Modal Expressions)',
                'category' => 'Modals and Semi-modals',
                'theory' => "Modal expressions — устойчивые словосочетания, которые ведут себя как модальные глаголы по смыслу (выражают возможность, необходимость, желание), хотя формально глаголами не являются: be able to, be allowed to, be supposed to, be bound to, would rather, would sooner.\n\nКогда используется:\n— be supposed to — то, что ожидается по правилам/договорённости (часто с оттенком «должен, но не всегда делает»): You're supposed to hand in the report by Monday.\n— be bound to — почти неизбежная уверенность: It's bound to rain during our holiday.\n— would rather / would sooner — предпочтение: I'd rather stay home tonight.\n— be allowed to — разрешение (аналог can/may во всех временах и формах): You won't be allowed to enter without a ticket.\n\nСтруктура:\nbe supposed to / be bound to / be allowed to + начальная форма глагола. would rather + начальная форма глагола (без to); would rather + подлежащее + Past Simple (если речь о другом человеке).\n\nПримеры:\nWe're supposed to wear formal clothes to the event. He's bound to be tired after such a long flight. I'd rather walk than take the bus. Are you allowed to leave work early today? She'd rather you didn't smoke here.\n\nДополнительные примеры:\nThe train is supposed to arrive at 6 p.m. Prices are bound to rise eventually. I'd sooner stay in than go to a noisy party. Children aren't allowed to enter without an adult. He's supposed to be studying, not watching TV.\n\nЧастые ошибки:\n— to после would rather: 'I'd rather to stay' — неправильно, нужно 'I'd rather stay'.\n— Present Simple вместо Past Simple после would rather + другое подлежащее: 'I'd rather you don't smoke' менее правильно, стандартно 'I'd rather you didn't smoke'.",
            ],
            [
                'level' => 'B2',
                'lesson' => '',
                'title' => 'Модальные глаголы в косвенной речи (Modals in Indirect Speech)',
                'category' => 'Modals and Semi-modals',
                'theory' => "При переводе прямой речи в косвенную (reported speech) многие модальные глаголы меняют форму — «сдвигаются назад» (backshift), подобно временам глагола.\n\nКогда используется:\n— после глагола сообщения в прошедшем времени (said, told): модальный глагол обычно сдвигается на «прошлую» форму.\n— некоторые модальные глаголы (could, would, should, might, ought to, needn't) НЕ меняются, так как у них уже нет отдельной формы прошедшего времени.\n\nФормы (типичные соответствия backshift):\ncan → could, will → would, may → might, must (обязанность) → had to (или остаётся must), shall → should. Не меняются: could, would, should, might, ought to, mustn't, needn't.\n\nПримеры:\n'I can swim,' she said. → She said she could swim. 'I will call you,' he said. → He said he would call me. 'You must finish it today,' she said. → She said I had to finish it that day. 'It might rain,' he said. → He said it might rain.\n\nДополнительные примеры:\n'I may be late,' she said. → She said she might be late. 'You should apologise,' he said. → He said I should apologise. 'We can't come,' they said. → They said they couldn't come. 'I would help if I could,' she said. → She said she would help if she could.\n\nЧастые ошибки:\n— Изменение модальных глаголов, у которых уже нет отдельной прошедшей формы: 'She said she mighted come' — неправильно, might не меняется, остаётся 'She said she might come'.\n— Пропуск backshift там, где он нужен: 'He said he will call' часто исправляют на 'He said he would call' в формальном/письменном стиле, хотя в разговорной речи will иногда сохраняется, если ситуация ещё актуальна.",
            ],
